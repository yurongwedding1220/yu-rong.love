...
/** 相簿入口輪播：之後換成 政憲 & 幸容 的照片 publicId */
export const ALBUM_HERO_COVER_IDS: string[] = [];
...
export const APP_CONTENT = {
  ...
  date: "日期待定",
  dateISO: "2026-12-31T12:00:00",
  location: "台灣",
  venueName: "場地待定",
  venueHall: "",
  venueAddress: "地址待定",
  venueDescription: "場地介紹待補。",
  quote: "宿霧、仙本那、蘇美、宮古——下一站，誠邀你來見證我們。",
...
/** 婚禮相簿頁面路由（GitHub Pages: /yu-rong.love/album） */
